...
import com.young.domain.model.DomainPlatformEntranceBody
...
object ModelFactory {
    fun generateDomainPlatformEntrance() = DomainPlatformEntrance(
        listOf(generateDomainPlatformEntranceBody() , generateDomainPlatformEntranceBody() , generateDomainPlatformEntranceBody()) ,
        generateHeader()
    )

    fun generateHeader() = com.young.domain.model.Header(
        randomInt() , randomString() , randomString()
    )

    fun generateDomainPlatformEntranceBody() = DomainPlatformEntranceBody(
        randomString() ,
        null ,
        null ,
        randomInt() ,
